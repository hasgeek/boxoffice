...
def format_row(row):
    fields = ['settlement_id', 'item_collection', 'order_id', 'payment_id', 'line_item_id',
        'item_title', 'base_amount', 'discounted_amount', 'final_amount', 'transaction_date',
        'payment_status', 'settled_at', 'razorpay_fees', 'order_amount', 'receivable_amount',
        'settlement_amount', 'buyer_fullname']
    for field in fields:
...
def write_settled_orders(filename, rows):
    with open(filename, 'w') as csvfile:
        fieldnames = ['settlement_id', 'item_collection', 'order_id', 'payment_id', 'line_item_id',
            'item_title', 'base_amount', 'discounted_amount', 'final_amount', 'transaction_date',
            'payment_status', 'settled_at', 'razorpay_fees', 'order_amount', 'receivable_amount',
            'settlement_amount', 'buyer_fullname']
