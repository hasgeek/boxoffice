...
def get_settled_orders(settlement_files):
    ...
    def format_row(row):
        fields = ['settlement_id', 'order_id', 'payment_id', 'line_item_id', 'item_title', 'base_amount', 'discounted_amount', 'final_amount', 'transaction_date', 'payment_status', 'settled_at', 'razorpay_fees', 'order_amount', 'receivable_amount', 'settlement_amount', 'buyer_fullname']
        for field in fields:
