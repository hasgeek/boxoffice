...
def get_refunds(date_ranges):
    """
    Returns a list of rows containing refund details in the format:
    refund_transaction_id, refund_description, amount, refunded_at, payment_id, settlement_id, order_id
    """
    entity_dict = {}
    entities = []
...
def write_refunds(filename, rows):
    with open(filename, 'w') as csvfile:
        fieldnames = ['transaction_id', 'refund_description', 'settlement_id', 'refunded_at', 'order_id', 'order_date', 'payment_id', 'amount']
