                    ...
                    format_row(
                        {
                            ...
                            # FIXME: 'credit':
                            # Decimal(entity_dict[settlement_refund_id]['credit']),
        ...
        for settlement_refund_id in settlement_refund_ids:
            ...
            try:
                ...
                if cancelled_line_item:
                    ...
                    refund_transaction = PaymentTransaction.query.filter(
                        ~PaymentTransaction.id.in_(refunded_transaction_ids),
