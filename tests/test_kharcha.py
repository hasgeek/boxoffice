...
from boxoffice.models import db, Item, DiscountPolicy, DiscountCoupon
from .test_db import TestDatabaseFixture


class TestKharchaAPI(TestDatabaseFixture):
    ...
    def test_undiscounted_kharcha(self):
        first_item = Item.query.filter_by(name=u'conference-ticket').first()
    ...
    #     first_item = Item.query.filter_by(name=u'conference-ticket').first()
    #     coupon = DiscountCoupon.query.filter_by(code=u'coupon1').first()
