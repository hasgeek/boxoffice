...
def upgrade():
    op.add_column('organization', sa.Column('contact_email', sa.Unicode(length=254), nullable=True))
    op.create_unique_constraint('organization_contact_email_key', 'organization', ['contact_email'])
