...
def upgrade():
    ...
    op.create_index(op.f('ix_line_item_discount_policy_id'), 'line_item', ['discount_policy_id'], unique=False)
    op.create_index(op.f('ix_line_item_discount_coupon_id'), 'line_item', ['discount_coupon_id'], unique=False)
