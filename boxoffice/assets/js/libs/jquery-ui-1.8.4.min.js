  ...
  d.widget('ui.draggable', d.ui.mouse, {
    ...
    _createHelper: function (a) {
      ...
      a.parents('body').length ||
        a.appendTo(b.appendTo == 'parent' ? this.element[0].parentNode : b.appendTo);
      a[0] != this.element[0] &&
...
(function (e) {
    ...
    _create: function () {
      ...
      if (this.handles.constructor == String) {
        ...
        for (var d = 0; d < c.length; d++) {
          var f = e.trim(c[d]),
            g = e(
              '<div class="ui-resizable-handle ' + ('ui-resizable-' + f) + '"></div>'
            );
  ...
  e.ui.plugin.add('resizable', 'containment', {
    ...
    resize: function (b) {
      ...
      c = Math.abs(
        (a._helper ? a.offset.left - g.left : a.offset.left - g.left) + a.sizeDiff.width
      );
      d = Math.abs(
        (a._helper ? a.offset.top - g.top : a.offset.top - d.top) + a.sizeDiff.height
      );
...
jQuery.effects ||
  (function (f, j) {
    function l(c) {
      ...
      if (
        (a = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(c))
      )
      ...
      function (c, a) {
        f.fx.step[a] = function (b) {
          ...
          b.elem.style[a] =
            'rgb(' +
            Math.max(
              Math.min(parseInt(b.pos * (b.end[0] - b.start[0]) + b.start[0], 10), 255),
              0
            ) +
            ',' +
            Math.max(
              Math.min(parseInt(b.pos * (b.end[1] - b.start[1]) + b.start[1], 10), 255),
              0
            ) +
            ',' +
            Math.max(
              Math.min(parseInt(b.pos * (b.end[2] - b.start[2]) + b.start[2], 10), 255),
              0
            ) +
            ')';
        };
    ...
    f.extend(f.easing, {
      ...
      easeOutElastic: function (c, a, b, d, e) {
        ...
        return (
          h * Math.pow(2, -10 * a) * Math.sin(((a * e - c) * 2 * Math.PI) / g) + d + b
        );
      },
...
(function (c) {
  c.effects.slide = function (d) {
    return this.queue(function () {
      ...
      var g =
        d.options.distance ||
        (f == 'top' ? a.outerHeight({ margin: true }) : a.outerWidth({ margin: true }));
            ...
            a.toHide
              ...
              .animate(h, {
                step: function (j, i) {
                  if (i.prop == 'height')
                    f =
                      i.end - i.start === 0 ? 0 : (i.now - i.start) / (i.end - i.start);
  ...
  e.widget('ui.menu', {
    ...
    nextPage: function (a) {
      if (this.hasScroll())
        ...
        this.activate(
          a,
          this.element.children(!this.active || this.last() ? ':first' : ':last')
        );
    },
    previousPage: function (a) {
      if (this.hasScroll())
        ...
        this.activate(
          a,
          this.element.children(!this.active || this.first() ? ':last' : ':first')
        );
    },
    hasScroll: function () {
    ...
    _resetButton: function () {
      if (this.type === 'input')
        ...
        if (d.primary || d.secondary) {
          b.addClass(
            'ui-button-text-icon' + (e ? 's' : d.primary ? '-primary' : '-secondary')
          );
          d.primary &&
            b.prepend(
          ...
          if (!this.options.text) {
            b.addClass(e ? 'ui-button-icons-only' : 'ui-button-icon-only').removeClass(
  ...
  d.extend(L.prototype, {
    ...
    _showDatepicker: function (a) {
      ...
      if (!(d.datepicker._isDisabledDatepicker(a) || d.datepicker._lastInput == a)) {
        ...
        b.dpDiv.css({
          position:
            d.datepicker._inDialog && d.blockUI ? 'static' : e ? 'fixed' : 'absolute',
          display: 'none',
          left: c.left + 'px',
          top: c.top + 'px',
        });
      ...
      if (!(!b || (a && b != d.data(a, 'datepicker'))))
        if (this._datepickerShowing) {
          ...
          d.effects && d.effects[a]
            ...
            : b.dpDiv[
                a == 'slideDown' ? 'slideUp' : a == 'fadeIn' ? 'fadeOut' : 'hide'
              ](a ? c : null, e);
          a || e();
    ...
    _selectDay: function (a, b, c, e) {
      var f = d(a);
      if (
        !(d(e).hasClass(this._unselectableClass) || this._isDisabledDatepicker(f[0]))
      ) {
        f = this._getInst(f[0]);
          ...
          if (u)
            ...
            switch (a.charAt(j)) {
              ...
              case 'o':
                l += g(
                  'o',
                  (b.getTime() - new Date(b.getFullYear(), 0, 0).getTime()) / 864e5,
                  3
                );
                break;
              case 'm':
          ...
          for (var O = 0; O < A; O++) {
            ...
            for (t = 0; t < 7; t++) {
              ...
              P +=
                ...
                ((q.getTime() == J.getTime() && g == a.selectedMonth && a._keyEvent) ||
    ...
    _create: function () {
      ...
      var a = this,
        ...
        g = (a.uiDialog = c('<div></div>'))
          ...
          .hide()
          .addClass(
            'ui-dialog ui-widget ui-widget-content ui-corner-all ' + b.dialogClass
          )
          .css({ zIndex: b.zIndex })
          .attr('tabIndex', -1)
          .css('outline', 0)
    ...
    flip: {
      left: function (a, b) {
        if (b.at[0] !== 'center') {
          ...
          var e =
              b.my[0] === 'left' ? -b.elemWidth : b.my[0] === 'right' ? b.elemWidth : 0,
            g = -2 * b.offset[0];
          a.left +=
            a.left < 0 ? e + b.targetWidth + g : d > 0 ? e - b.targetWidth + g : 0;
        }
      },
      top: function (a, b) {
        if (b.at[1] !== 'center') {
...
(function (d, p) {
  ...
  d.widget('ui.tabs', {
    ...
    _cookie: function () {
      var a =
        this.cookie || (this.cookie = this.options.cookie.name || 'ui-tabs-' + w());
