...
def jsonify_item_collection(item_collection_dict):
    ...
    return jsonify(org=item_collection_dict['org'], 
...
def admin_item_collection(item_collection):
    ...
    return dict(org=item_collection.organization.name, item_collection=item_collection, date_item_counts=date_item_counts,
