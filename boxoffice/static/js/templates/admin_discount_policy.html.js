                  ...
                  <form role="form" id="policy-form-{{id}}"> 
                    ...
                    {{#if is_price_based}}
                      {{#price_details}}
                        ...
                        <div class="group"> 
                          <input id="add-item-{{id}}" name="item" type="hidden" required value="{{get_discounted_items(dp_items)}}">
                        </div>
                      {{/}}
                    {{else}}
                      <div class="group">   
                      ...
                      <div class="group"> 
                        <input id="add-items-{{id}}" name="items" type="hidden" required value="{{get_discounted_items(dp_items)}}">
                      </div>
                    {{/if}}
                    <div class="btn-wrapper">
              ...
              {{elseif show_add_coupon_form}}
                <div class="content-box clearfix" intro='fly:{"x":20,"y":"0"}'>
                  ...
                  <form role="form" id="new-coupon-{{id}}">
                    <div class="group">   
                      <input class="group-input filled" type="number" name="count" required min="1" value="{{count_coupons}}">
                      <span class="bar"></span>
                      <label class="group-label">How many coupons?</label>
                    </div>
                    {{#if count_coupons == 1}}
                      <div class="group">   
                        <input class="group-input" type="text" name="coupon_code" value="">
                        <span class="bar"></span>
