...
class DiscountPolicyForm(forms.Form):
    ...
    price_title = forms.StringField(__("Price Title"),
        validators=[forms.validators.OptionalIfNot('is_price_based',
            (u"Please specify a price title")), forms.validators.Length(max=250),
