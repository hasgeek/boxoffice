...
class DiscountForm(forms.Form):
    ...
    discount_code_base = forms.StringField(__("Discount Title"), validators=[forms.validators.OptionalIfNot('discount_type'), forms.validators.Length(max=20), forms.validators.StripWhitespace()])
