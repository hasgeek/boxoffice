...
def init_for(env):
    ...
    baseframe.init_app(app, requires=['boxoffice'], ext_requires=['baseframe-bs3-select2', 'fontawesome>=4.0.0', 'ractive', 'ractive-transitions-fly', 'validate', 'nprogress', 'baseframe-footable'])
